# Generated by Django 3.1.7 on 2021-04-04 09:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('estado', models.CharField(choices=[(groomeet_backend.models.EstadoInvitacion['Rechazada'], 'Rechazada'), (groomeet_backend.models.EstadoInvitacion['Pendiente'], 'Pendiente'), (groomeet_backend.models.EstadoInvitacion['Aceptada'], 'Aceptada')], max_length=9)),
                ('banda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='groomeet_backend.banda')),
